  ...
  return (
    <div className=" grid grid-cols-12 sm:p-10 mt-2">
      <div className="col-span-12 sm:col-span-6 flex flex-col gap-7">
        <h1 className="text-5xl text-center sm:text-left sm:text-8xl font-bold font-Inter	">
          Brand
          <br />
          Growth for
          <br />
          <span className="animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent font-Inter text-5xl sm:text-8xl font-black">
            Gen-Z
          </span>
        </h1>
        <div className="w-full flex items-center sm:justify-start justify-center">
          <p className="w-4/5 sm:text-left text-center">
        ...
        <div className="hidden sm:flex items-center justify-start gap-5 ">
          <button className="btn w-1/4 btn-active bg-violet-700 hover:bg-violet-600 active:bg-violet-700 shadow-lg shadow-violet-700/30 rounded-xl capitalize">
            Contat Us
          </button>
          <button className="btn w-1/4 btn-outline border-2 border-white hover:border-white hover:bg-transparent rounded-xl text-white  capitalize">
            Explore More
          </button>
        </div>
      </div>
      <div className="col-span-12 sm:col-span-6 gap-10 mt-10 sm:mt-0 flex flex-col justify-center ">
        ...
        <div className="flex sm:hidden items-center justify-evenly gap-5 ">
          <button className="btn w-1/3 btn-active bg-violet-700 hover:bg-violet-600 active:bg-violet-700 shadow-lg shadow-violet-700/30 rounded-xl capitalize">
            Contat Us
          </button>
